...
const router = useRouter()
  ...
  return (
    <Card  onClick={()=> router.push(onClick)}
      className="max-w-sm h-[500px] w-[280px] mx-10 cursor-pointer hover:scale-10 transition ease-in-out delay-150  hover:-translate-y-1hover:scale-110 duration-300 ..."
      renderImage={() => (
        <img
          src={image}
